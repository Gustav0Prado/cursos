...
void mulVetVetDiagonal (double *restrict vetDiagonal, double *restrict v2, double *restrict res, int n) {
   for (int i = 0; i < n; i++){
...
//retorna v1*A*v2
double multVetMatVet(double *restrict v1, SistLinear_t *restrict SL, double *restrict v2, int n){
...
double residuoDiag(SistLinear_t *restrict SL, double *restrict b, double *restrict x, double *restrict r){
